...
export default function DashboardContent({ activeSection, userData, onUpdateProfile, darkMode, toggleDarkMode }) {
  ...
  const sectionDescriptions = {
    overview: 'Lagos State NYSC Dashboard - Center of Excellence',
    ...
    <div>
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-2">
          <div className="w-8 h-8 bg-gradient-to-r from-[#008753] to-[#1EB2A6] rounded-lg flex items-center justify-center text-white font-bold">
            LAG
          </div>
        ...
        <p className={`mt-1 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
          {sectionDescriptions[activeSection] || 'Lagos State Dashboard'}
        </p>
      </div>
