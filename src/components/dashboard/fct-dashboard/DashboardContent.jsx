...
export default function DashboardContent({ activeSection, userData, onUpdateProfile, darkMode, toggleDarkMode }) {
  ...
  const sectionDescriptions = {
    overview: 'FCT Abuja Dashboard - Federal Capital Territory',
    ...
    <div>
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-2">
          <div className="w-8 h-8 bg-[#008753] rounded-lg flex items-center justify-center text-white font-bold">
            FCT
          </div>
        ...
        <p className={`mt-1 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
          {sectionDescriptions[activeSection] || 'FCT Abuja Dashboard'}
        </p>
      </div>
